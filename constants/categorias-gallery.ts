    ...
    data: [
      {
        ...
        text: "Te doy gracias Señor por este nuevo día.En unión con el Santo sacrificio de la misa en todo el mundo, te ofrezco mis oraciones, mi trabajo, mis alegrías y mis sufrimientos.Te lo ofrezco todo por las intenciones del sagrado Corazón de tu hijo Jesús, en reparación del daño hecho por el pecado, por la conversión del mundo y por las intenciones del Santo Padre.Amén",
        image: "@/assets/images/oraciones-diarias.jpg.jpg",
      },
      {
        id: "2",
        title: "Angelus",
        text: "V. El Ángel del Señor anunció a María. R. Y ella concibió por obra del Espíritu Santo. Ave María. V. He aquí la esclava del Señor. R. Hágase en mí según tu palabra. Ave María. V. La palabra se hizo carne. R. Y acampó entre nosotros. Ave María. V. Ruega por nosotros, Santa Madre de Dios. R. Para que seamos dignos de alcanzar las promesas de Nuestro Señor Jesucristo. Oremos Derrama, Señor tu gracia sobre nosotros, que, por el anuncio del ángel, hemos conocido la encarnación de tu Hijo, para que lleguemos por su pasión y su cruz a la gloria de la resurrección. Por Cristo, nuestro Señor. Amén. ",
